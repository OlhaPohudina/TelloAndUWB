...
tello1_address = ('192.168.137.168', 8889)
tello2_address = ('192.168.137.208', 8889)

#tello3_address = ('192.168.137.82', 8889)

# IP and port of local computer ["192.168.137.146", "192.168.137.59"
local1_address = ('', 9010)
local2_address = ('', 9011)
#local3_address = ('', 9012)
...
# Each leg of the box will be 50 cm. Tello uses cm units by default.
...
#for i in range(4):
  # Fly forward
send("curve 60 -60 0 0 -120 0 10", 25)
  # Yaw right
send("curve -60 60 0 0 120 0 10", 25)
